...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'spreadsheet.columnA': 'Column A: Product Name',
    'spreadsheet.columnB': 'Column B: Description',
    'spreadsheet.columnC': 'Column C: Price',
    'spreadsheet.columnD': 'Column D: Compare Price (optional)',
    'spreadsheet.columnE': 'Column E: Category',
    'spreadsheet.columnF': 'Column F: Tags (comma-separated)',
    'spreadsheet.columnG': 'Column G: Image URLs (comma-separated)',
    'spreadsheet.columnH': 'Column H: File URL',
    'spreadsheet.columnI': 'Column I: Status (DRAFT/PUBLISHED/ARCHIVED)',
  ...
  ar: {
    ...
    'spreadsheet.columnA': 'العمود A: اسم المنتج',
    'spreadsheet.columnB': 'العمود B: الوصف',
    'spreadsheet.columnC': 'العمود C: السعر',
    'spreadsheet.columnD': 'العمود D: سعر المقارنة (اختياري)',
    'spreadsheet.columnE': 'العمود E: الفئة',
    'spreadsheet.columnF': 'العمود F: العلامات (مفصولة بفواصل)',
    'spreadsheet.columnG': 'العمود G: عناوين URL للصور (مفصولة بفواصل)',
    'spreadsheet.columnH': 'العمود H: عنوان URL للملف',
    'spreadsheet.columnI': 'العمود I: الحالة (DRAFT/PUBLISHED/ARCHIVED)',
