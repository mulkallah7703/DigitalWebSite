...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Company Landing
    'company.tagline': 'SaaS • Technology • Creative Services',
    'company.name': 'Codec',
    'company.heroTitle': 'The leading company in transforming ideas into ',
    'company.heroHighlight': 'powerful digital solutions',
    'company.heroDesc': 'We build smart, scalable digital solutions',
    'company.ctaStore': 'Open Digital E-commerce',
    'company.ctaContactUs': 'Contact Us',
    'company.aboutTitle': 'About Us',
    'company.aboutDesc': 'We are a forward-thinking digital company focused on innovation, creativity, and technology. Our mission is to empower businesses with modern digital solutions that drive real impact and long-term success.',
    'company.aboutPillar1': 'Precision and excellence in every project',
    'company.aboutPillar2': 'Clear vision for digital transformation',
    'company.aboutPillar3': 'AI-powered efficiency and innovation',
    'company.aboutCta': 'Learn More About Us',
    'about.heroTitle': 'About Us',
    'about.heroDesc': 'We are a forward-thinking digital company focused on innovation, creativity, and technology. Our mission is to empower businesses with modern digital solutions that drive real impact and long-term success.',
    'about.teamTitle': 'Meet Our Team',
    'about.teamDesc': 'A passionate team of innovators, designers, and developers dedicated to building exceptional digital experiences.',
    'about.founderRole': 'Founder — Driving Innovation in Digital Technology',
    'company.servicesTitle': 'Our Services',
    'company.servicesDesc': 'A premier company specializing in digital services, delivering innovative solutions in design, development, and AI-powered technologies to help businesses grow and scale.',
    'company.service1': 'Visual Identity (Graphic Design)',
    'company.service2': 'Video Editing',
    'company.service3': 'Audio Engineering (Podcasts, etc.)',
    'company.service4': 'Scientific Research',
    'company.service5': 'Programming: Websites, Digital Menus, Software',
    'company.service6': 'Artistic Productions',
    'company.service7': 'Social Media Management (Targeted Followers)',
    'company.service8': 'AI Services',
    'company.productTitle': 'Digital E-commerce',
    'company.productDesc': 'A premier company specializing in digital services, delivering innovative solutions in design, development, and AI-powered technologies to help businesses grow and scale.',
    'company.productCta': 'Exceplore Digital E-commerce',
    'company.ctaTitle': 'Ready to Get Started?',
    'company.ctaDesc': 'Explore our digital store or get in touch to discuss your project.',
    'company.ctaButton': 'Start Your Project',
    // Contact
    'contact.title': 'Get in Touch',
    'contact.subtitle': 'Have a project in mind? Let\'s build something amazing together.',
    'contact.formInstruction': 'Please fill in the following information so our team can contact you',
    'contact.formName': 'Name',
    'contact.formEmail': 'Email',
    'contact.formPhone': 'Phone',
    'contact.formMessage': 'Message',
    'contact.formMessagePlaceholder': 'Write your message here',
    'contact.formSubmit': 'Send',
    'contact.success': 'Message Sent',
    'contact.successDesc': 'Thank you! We will get back to you soon.',
    'contact.error': 'Error',
    'contact.errorRequired': 'Please fill in all required fields',
    'contact.errorDesc': 'Failed to send your message. Please try again.',
    // Footer
    ...
    'footer.legal': 'Legal',
    'footer.description': 'A premier company specializing in digital services, delivering innovative solutions in design, development, and AI-powered technologies to help businesses grow and scale.',
  ...
  ar: {
    ...
    // Company Landing
    'company.tagline': 'SaaS • تقنية • خدمات إبداعية',
    'company.name': 'كودك',
    'company.heroTitle': 'الشركة الرائدة في تحويل الأفكار إلى ',
    'company.heroHighlight': 'حلول رقمية قوية',
    'company.heroDesc': 'نبني حلولًا رقمية ذكية وقابلة للتوسع',
    'company.ctaStore': 'فتح المتجر الرقمي',
    'company.ctaContactUs': 'اتصل بنا',
    'company.aboutTitle': 'من نحن',
    'company.aboutDesc': 'نحن شركة رقمية تتطلع للمستقبل وتركز على الابتكار والإبداع والتقنية. مهمتنا تمكين الشركات بحلول رقمية حديثة تحقق تأثيراً حقيقياً ونجاحاً طويل الأمد.',
    'company.aboutPillar1': 'دقة وتميز في كل مشروع',
    'company.aboutPillar2': 'رؤية واضحة للتحول الرقمي',
    'company.aboutPillar3': 'كفاءة وابتكار مدعوم بالذكاء الاصطناعي',
    'company.aboutCta': 'تعرف علينا أكثر',
    'about.heroTitle': 'من نحن',
    'about.heroDesc': 'نحن شركة رقمية تتطلع للمستقبل وتركز على الابتكار والإبداع والتقنية. مهمتنا تمكين الشركات بحلول رقمية حديثة تحقق تأثيراً حقيقياً ونجاحاً طويل الأمد.',
    'about.teamTitle': 'فريقنا',
    'about.teamDesc': 'فريق شغوف من المبتكرين والمصممين والمطورين ملتزمون ببناء تجارب رقمية استثنائية.',
    'about.founderRole': 'المؤسس — ريادة الابتكار في التقنية الرقمية',
    'company.servicesTitle': 'خدماتنا',
    'company.servicesDesc': 'شركة رائدة متخصصة في الخدمات الرقمية، تقدم حلولاً مبتكرة في التصميم والتطوير وتقنيات الذكاء الاصطناعي لمساعدة الشركات على النمو والتوسع.',
    'company.service1': 'الهوية البصرية (التصميم الجرافيكي)',
    'company.service2': 'مونتاج الفيديو',
    'company.service3': 'هندسة الصوت (البودكاست وغيرها)',
    'company.service4': 'البحث العلمي',
    'company.service5': 'البرمجة: مواقع، قوائم رقمية، برمجيات',
    'company.service6': 'الإنتاجات الفنية',
    'company.service7': 'إدارة وسائل التواصل (متابعين مستهدفين)',
    'company.service8': 'خدمات الذكاء الاصطناعي',
    'company.productTitle': 'المتجر الرقمي',
    'company.productDesc': 'شركة رائدة متخصصة في الخدمات الرقمية، تقدم حلولاً مبتكرة في التصميم والتطوير وتقنيات الذكاء الاصطناعي لمساعدة الشركات على النمو والتوسع.',
    'company.productCta': 'Exceplore Digital E-commerce',
    'company.ctaTitle': 'هل أنت مستعد للبدء؟',
    'company.ctaDesc': 'استكشف متجرنا الرقمي أو تواصل معنا لمناقشة مشروعك.',
    'company.ctaButton': 'ابدأ مشروعك',
    // Contact
    'contact.title': 'تواصل معنا',
    'contact.subtitle': 'لديك مشروع في ذهنك؟ لنبني شيئاً رائعاً معاً.',
    'contact.formInstruction': 'الرجاء تعبئة البيانات التالية ليقوم فريقنا بالتواصل معك',
    'contact.formName': 'الاسم',
    'contact.formEmail': 'البريد الإلكتروني',
    'contact.formPhone': 'الجوال',
    'contact.formMessage': 'الرسالة',
    'contact.formMessagePlaceholder': 'اكتب رسالتك هنا',
    'contact.formSubmit': 'الإرسال',
    'contact.success': 'تم إرسال رسالتك',
    'contact.successDesc': 'شكراً لك! سنتواصل معك قريباً.',
    'contact.error': 'خطأ',
    'contact.errorRequired': 'الرجاء تعبئة جميع الحقول المطلوبة',
    'contact.errorDesc': 'فشل إرسال رسالتك. يرجى المحاولة مرة أخرى.',
    // Footer
    ...
    'footer.legal': 'قانوني',
    'footer.description': 'شركة رائدة متخصصة في الخدمات الرقمية، تقدم حلولاً مبتكرة في التصميم والتطوير وتقنيات الذكاء الاصطناعي لمساعدة الشركات على النمو والتوسع.',
