...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'company.heroTitle': 'Transform Your Business with',
    'company.heroHighlight': 'Expert Solutions',
    'company.heroDesc': 'From graphic design and video editing to AI-powered software—we deliver premium digital services and products tailored for growth.',
    'company.ctaStore': 'Open Digital E-commerce',
    'company.ctaContactUs': 'Contact Us',
    'company.aboutTitle': 'About Us',
    'company.aboutDesc': 'We combine technology, creativity, and AI to deliver exceptional digital services and products. Our vision is to empower businesses and creators with professional-grade solutions.',
    ...
    'company.servicesDesc': 'Comprehensive digital solutions for businesses and creators.',
    ...
    'company.productDesc': 'Explore our curated marketplace of digital products—software, templates, courses, and more. Powered by AI for personalized recommendations.',
    'company.productCta': 'Open Digital E-commerce',
    'company.ctaTitle': 'Ready to Get Started?',
    'company.ctaDesc': 'Explore our digital store or get in touch to discuss your project.',
    'company.ctaButton': 'Go to Store',
    // Contact
    'contact.title': 'Contact Us',
    'contact.subtitle': 'Your request is the starting point for a meticulously designed solution',
  ...
  ar: {
    ...
    'company.heroTitle': 'حوّل عملك مع',
    'company.heroHighlight': 'حلول احترافية',
    'company.heroDesc': 'من تصميم الجرافيك ومونتاج الفيديو إلى البرمجيات المدعومة بالذكاء الاصطناعي—نقدم خدمات ومنتجات رقمية متميزة مصممة للنمو.',
    'company.ctaStore': 'فتح المتجر الرقمي',
    'company.ctaContactUs': 'اتصل بنا',
    'company.aboutTitle': 'من نحن',
    'company.aboutDesc': 'نجمع بين التقنية والإبداع والذكاء الاصطناعي لتقديم خدمات ومنتجات رقمية استثنائية. رؤيتنا تمكين الشركات والمبدعين بحلول احترافية.',
    ...
    'company.servicesDesc': 'حلول رقمية شاملة للشركات والمبدعين.',
    ...
    'company.productDesc': 'استكشف سوقنا المختار من المنتجات الرقمية—برمجيات، قوالب، دورات، والمزيد. مدعوم بالذكاء الاصطناعي للتوصيات الشخصية.',
    'company.productCta': 'فتح المتجر الرقمي',
    'company.ctaTitle': 'هل أنت مستعد للبدء؟',
    'company.ctaDesc': 'استكشف متجرنا الرقمي أو تواصل معنا لمناقشة مشروعك.',
    'company.ctaButton': 'الذهاب للمتجر',
    // Contact
    'contact.title': 'اطلب خدماتنا الآن',
    'contact.subtitle': 'طلبك هو نقطة البداية لحل مصمم بدقة',
