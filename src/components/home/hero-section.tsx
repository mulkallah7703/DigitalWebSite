...
export function HeroSection() {
  ...
  const features = [
    { icon: Zap, label: t('home.instantDelivery') },
    { icon: Shield, label: t('home.secureDownloads') },
    { icon: Download, label: t('home.lifetimeAccess') },
  ]
  return (
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm font-medium">{t('home.aiMarketplace')}</span>
          </motion.div>
          ...
          >
            ...
            <span className="gradient-text">{t('home.digitalProducts')}</span>
          </motion.h1>
          ...
          >
            ...
            <Button asChild size="xl" variant="outline">
              <Link href="/categories">{t('home.exploreCategories')}</Link>
            </Button>
          </motion.div>
        ...
        <div className="hidden lg:block">
          <motion.div
            ...
            className="absolute left-10 top-1/3 glass-card rounded-2xl p-4 w-48 animate-float"
          >
            ...
            <h4 className="font-semibold text-sm mb-1">{t('home.fastDelivery')}</h4>
            <p className="text-xs text-muted-foreground">{t('home.instantAccess')}</p>
          </motion.div>
          ...
          <motion.div
            ...
            className="absolute right-10 top-1/2 glass-card rounded-2xl p-4 w-48 animate-float delay-500"
          >
            ...
            <h4 className="font-semibold text-sm mb-1">{t('home.securePayment')}</h4>
            <p className="text-xs text-muted-foreground">{t('home.protectedByStripe')}</p>
          </motion.div>
        </div>
      </div>
    </section>
